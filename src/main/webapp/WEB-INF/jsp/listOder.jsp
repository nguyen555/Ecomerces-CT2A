                                    ...
                                    <tbody>
                                        <c:forEach var="orders" items="${OrderList}">
                                            <tr>
                                                ...
                                                <td>${orders.priceFormatted}</td>
                                                <td>${orders.date}</td>
                                                <td>${orders.phone}</td>
                                                <td>${orders.email}</td>
                                                
                                                <td><a href="${pageContext.request.contextPath}/viewOrderdetails/${orders.id}">View Details</a></td>
                                                <td><a href="${pageContext.request.contextPath}/editOder/${orders.id}">Edit</a></td>
                                                <td><a href="${pageContext.request.contextPath}/deleteOder/${orders.id}">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
