                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary"><a href="${pageContext.request.contextPath}/addManufacture" style="color: black">Add New</a></button>
                            </div>
                                    ...
                                    <tbody>
                                        <c:forEach var="manufacturer" items="${manufactureList}">
                                            <tr>
                                                ...
                                                <td><img src="<c:url value="./img/${manufacturer.images}"/>" alt=""></td>
                                                <td><a href="${pageContext.request.contextPath}/viewManufacture/${manufacturer.id}">View Details</a></td>
<!--                                               <td><a href="${pageContext.request.contextPath}/editManufacture/${manufacturer.id}">Edit</a></td>-->
                                                <td><a href="${pageContext.request.contextPath}/deletemanufacture/${manufacturer.id}">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
