                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel-body">
                            ...
                            <mvc:form modelAttribute="customerList" action="${pageContext.request.contextPath}/updateCustomer" class="form-horizontal form-bordered" method="post">
                                <mvc:input path="id" type="hidden"/>
                                <mvc:input path="id" type="hidden"/>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="inputDefault">Customer ID</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <mvc:input path="email" rrequired="true" class="form-control" id="inputDefault" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="input">Birth Date</label>
                                    <div class="col-md-6">
                                        <mvc:input path="birthDate" required="true" class="form-control" id="inputDefault"/>
                                    </div>
                                </div>
                                    <div class="form-group">
                                    <label class="col-md-3 control-label" for="input">Sex</label>
                                    <div class="col-md-6">
                                        <mvc:input path="sex" required="true" class="form-control" id="inputDefault"/>
                                    </div>
                                </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <label class="col-md-3 control-label" for="input">Address</label>
                                    <div class="col-md-6">
                                        <mvc:input path="address" required="true" class="form-control" id="inputDefault"/>
                                    </div>
                                </div>
