                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary"><a href="${pageContext.request.contextPath}/addColor" style="color: black">Add New</a></button>
                            </div>
                                    ...
                                    <tbody>
                                        <c:forEach var="color" items="${ColorList}">
                                            <tr>
                                                ...
                                                <td><img src="<c:url value="./img/${color.img}"/>" alt=""></td>
                                                <td><a href="${pageContext.request.contextPath}/viewColordetails/${color.id}">View Details</a></td>
<!--                                               <td><a href="${pageContext.request.contextPath}/editColort/${color.id}">Edit</a></td>-->
                                                <td><a href="${pageContext.request.contextPath}/deleteColor/${color.id}">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
