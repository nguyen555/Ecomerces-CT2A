                    ...
                    <div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
                        <div class="side-bar p-sm-4 p-3">
                            ...
                            <div class="left-side border-bottom py-2">
                                <h3 class="agileits-sear-head mb-3">Bộ Lọc</h3>
                                <form action="${pageContext.request.contextPath}/check" method="POST">
                                <ul>
                                    <li><a>Loại điện thoại</a><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">Android</span><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">iPhone(iOS)</span><br>
                                    </li>
                                    <li><a>Dung Lượng Pin</a><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">Từ 3000-5000</span><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">Dung lượng pin khủng trên 5000</span><br>
                                    </li>
                                    <li><a>Dung Lượng Ram</a><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">Dưới 4GB</span><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">Từ 4-6GB</span><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">Trên 6GB</span><br>
                                    </li>
                                    <li><a>Bộ Nhớ trong</a><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">Dưới 32 GB</span><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">Từ 32-64GB</span><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">Từ 64- 128GB</span><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">Từ 128-256GB</span><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">Từ 256-512GB</span><br>

                                    </li>
                                    <li><a>SIM</a><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">1 Sim</span><br>
                                        <input type="checkbox" class="checked">
                                        <span class="span">2 Sim</span><br>
                                    </li>
