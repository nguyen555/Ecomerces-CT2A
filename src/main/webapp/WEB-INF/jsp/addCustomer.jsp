                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel-body">
                            ...
                            <mvc:form modelAttribute="customer" action="${pageContext.request.contextPath}/updateaddCustomer" class="form-horizontal form-bordered" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <mvc:input path="birthDate" required="true" class="form-control" type="date" id="inputDefault"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="input">Sex</label>
                                    <div class="col-md-6">
                                        <mvc:select path="sex" required="true" items="${sex1}" class="form-control" id="inputDefault"/>
                                    </div>
                                </div>
                                <div class="form-group">
