<%-- 
    Document   : homeFooterJquery
    Created on : 19 thg 10, 2020, 08:43:35
    Author     : HP
--%>
...
<html>
    ...
    <!-- jQuery UI 1.11.2 -->
    <script src="${pageContext.request.contextPath}/http://code.jquery.com/ui/1.11.2/jquery-ui.min.js" type="text/javascript"></script>
    ...
    <!-- Morris.js charts -->
    <script src="${pageContext.request.contextPath}/http://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
