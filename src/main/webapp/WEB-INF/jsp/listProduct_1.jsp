                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary"><a href="${pageContext.request.contextPath}/addProduct" style="color: black">Add New</a></button>
                            </div>
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary"><a href="${pageContext.request.contextPath}/listexcel" style="color: black">DownLoad Excel</a></button>
                            </div>
                            <div class="col-xs-6">
                                    ...
                                    <tbody>
                                        <c:forEach var="product" items="${productList}">
                                            <tr>
                                                ...
                                                <td><img src="<c:url value="/img/${product.image}"/>" alt="">
                                                </td>
...
<!--                                                <td>${product.productdetails.boNhoTrong}</td>-->
                                                ...
                                                <td><a href="${pageContext.request.contextPath}/editProduct/${product.id}">Edit</a></td>
                                                <td><a href="${pageContext.request.contextPath}/delete/${product.id}">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                        ...
                        <div class="container">
                            <ul class="pagination" style="padding-left: 35%">
                                ...
                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/view-all-Product1/1">1</a></li>
                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/view-all-Product1/2">2</a></li>
                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/view-all-Product1/3">3</a></li>
                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/view-all-Product1/4">4</a></li>
