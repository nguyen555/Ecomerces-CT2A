                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel-body">
                            ...
                            <mvc:form modelAttribute="manufacture" action="${pageContext.request.contextPath}/updateaddManufacture" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                                <mvc:input path="id" type="hidden"/>


                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="inputDefault">Manufacture Name</label>
                                    <div class="col-md-6">
